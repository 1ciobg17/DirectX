...
void Model::Draw(XMMATRIX* view, XMMATRIX* projection)
{
	...
	XMMATRIX rotX = XMMatrixRotationX(m_xangle);
	XMMATRIX rotY = XMMatrixRotationY(m_yangle);
	XMMATRIX rotZ = XMMatrixRotationZ(m_zangle);
	...
	//world = XMMatrixScaling(m_scale, m_scale, m_scale)*XMMatrixRotationX(m_xangle)*XMMatrixRotationY(m_yangle)*XMMatrixRotationZ(m_zangle)*XMMatrixTranslation(m_x, m_y, m_z);
